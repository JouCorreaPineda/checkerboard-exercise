...
function squareCreator(){
    for(var i=0;i<81;i++){
        ...
        var color1neg = (255 - color1).toString()
        var color2neg = (255 - color2).toString()
        var color3neg = (255 - color3).toString()
        var rgbneg = "rgb("+color1neg+","+color2neg+","+color3neg+")"
        ...
        if(i%2==0){
            ...
            square.style.backgroundImage = 'linear-gradient(to bottom,'+square.style.backgroundColor+','+rgbneg+')';
